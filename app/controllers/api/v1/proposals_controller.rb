  ...
  private
    ...
    def proposal_params
      params.require(:proposal).permit(:multi_app_identifier, :proposal_status_id, :category, :creator_id, 
        ...
        :lives_in_poland, :address_id, :teryt_code, :province_code, :province_name, :district_code, :district_name,
        :commune_code, :commune_name, :city_code, :city_name, :street_code, :street_name, :street_attribute,
