class EsodOutgoingLettersController < ApplicationController
  ...
  private
    ...
    def esod_outgoing_letter_params
      ...
      :data_utworzenia, :identyfikator_osoby_tworzacej, :data_modyfikacji, :identyfikator_osoby_modyfikujacej, :initialized_from_esod, :netpar_user, :document_id, document_ids: [])
    end
