...
class Esod::Token
  ...
  def initialize(esod_email, esod_pass)
    client = Savon.client(
      ...
      wsdl: "#{Esodes::API_SERVER}/services/BezpieczenstwoUsluga?wsdl",
      endpoint: "#{Esodes::API_SERVER}/services/BezpieczenstwoUsluga.BezpieczenstwoUslugaHttpsSoap11Endpoint",
